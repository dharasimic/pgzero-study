...
**[⬇️ Baixar Dungeon Survival (.exe)](https://github.com/dharasimic/pgzero-study/releases)**
...
Este projeto utiliza assets de terceiros. Todos os créditos pertencem aos seus respectivos autores:

* **Dungeon Tileset II** — 0x72
* **HEL - Circle SFX and Music** — EvilDuckk
* **UI - User Interface Medieval** — ToffeeCraft
* **Monogram** — Datagoblin
* **Dungeon Wall** — Adobe Stock

### 🔗 Fontes

* https://0x72.itch.io/dungeontileset-ii
* https://evilduckk.itch.io/hel-circle-sfx-and-music
* https://toffeecraft.itch.io/ui-user-interface-medieval
* https://datagoblin.itch.io/monogram
* https://stock.adobe.com/br/search?k=dungeon+wall
...
Para executar o projeto diretamente pelo Python, é necessário ter o Python instalado e as dependências do projeto configuradas.
